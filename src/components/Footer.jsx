        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 glass rounded-lg text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">
                <Globe size={18} />
              </a>
              <a href="#" className="p-2 glass rounded-lg text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">
                <Globe size={18} />
          ...
          {/* Services */}
          <div>
            <h4 className="font-display font-bold mb-6">Soluciones</h4>
            <ul className="flex flex-col gap-4">
              <li><a href="#" className="text-sm text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">Asesoramiento</a></li>
              <li><a href="#" className="text-sm text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">Tecnología</a></li>
              <li><a href="#" className="text-sm text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">Diagnóstico</a></li>
              <li><a href="#" className="text-sm text-brand-secondary hover:text-[var(--color-brand-cyan)] transition-colors">Análisis de Datos</a></li>
            </ul>
          </div>
