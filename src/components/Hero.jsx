      ...
      <div className="container mx-auto px-6 relative z-10 text-center md:text-left">
        <div className="max-w-4xl mx-auto md:mx-0">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-brand-secondary mb-10 max-w-2xl mx-auto md:mx-0 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-10 md:justify-start justify-center">
              <button className="btn-primary flex items-center gap-2 group w-full sm:w-auto justify-center">
                Conoce Nuestros Servicios
                <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
              </button>

              <button className="btn-secondary flex items-center gap-2 w-full sm:w-auto justify-center hover:border-[var(--color-brand-cyan)]/50">
                <div className="w-8 h-8 rounded-full bg-[var(--color-brand-cyan)]/20 flex items-center justify-center">
                  <Play size={14} className="text-[var(--color-brand-cyan)] fill-current" />
                </div>
                Ver Casos de Éxito
              </button>
            </div>
